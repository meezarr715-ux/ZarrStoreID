...
// Konstanta konversi mata uang (IDR to MYR)
const CURRENCY_CONVERSION = {
    IDR_TO_MYR: 0.00029, // 1 IDR = 0.00029 MYR (nilai contoh, bisa disesuaikan)
    formatIDR: (amount) => {
    ...
    convertToMYR: (idrAmount) => {
        return idrAmount * CURRENCY_CONVERSION.IDR_TO_MYR;
    }
};
...
const zarrStoreProducts = {
    ...
    products: [
        // Produk dalam folder "Aplikasi Premium"
        {
            ...
            name: "Alight Motion Premium 1 Tahun (Indonesia)",
            description: "Alight Motion Premium Bebas Iklan, Tanpa Watermark, Unlock Semua Efek, Penyimpanan Cloud 100GB.",
            price: 10000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1768468525/AM_LOGO_ztwyl9.jpg",
        },
        {
            id: "1-2",
            folderId: "folder-1",
            subCategoryId: "sub-1-1",
            name: "Alight Motion Premium 1 Tahun (Malaysia)",
            description: "Alight Motion Premium Bebas Iklan, Tanpa Watermark, Unlock Semua Efek, Penyimpanan Cloud 100GB.",
            price: 10000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1768468525/AM_LOGO_ztwyl9.jpg",
        },
        {
            ...
            description: "Canva Premium Dengan Semua Fitur Lengkap.",
            price: 10000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1770286544/logo_cva_mnwmqp.jpg",
        },
        {
            id: "1-4",
            folderId: "folder-1",
        ...
        // Produk dalam folder "Sewa Bot WhatsApp"
        {
            ...
            name: "Sewa Bot 4 Mingguan",
            description: "Bot WhatsApp Multi Device Cocok Untuk Menjaga Grup Dan lainnya",
            price: 15000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1768468525/ROBOT_WA_ef8xum.jpg",
        },
        {
            id: "2-2",
            folderId: "folder-2",
            subCategoryId: "sub-2-2",
            name: "Sewa Bot 6 Mingguan",
            description: "Bot WhatsApp Multi Device Cocok Untuk Menjaga Grup Dan lainnya",
            price: 17000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1768468525/ROBOT_WA_ef8xum.jpg",
        },
        ...
        },
        {
            id: "2-5",
            folderId: "folder-2",
            subCategoryId: "sub-2-5",
            name: "Sewa Bot Premium VVIP 3 Bulan",
            description: "Bot WhatsApp Multi Device Cocok Untuk Menjaga Grup Dan lainnya. Serta Akses Premium Untuk Semua Admin Grup",
            price: 50000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1768468525/ROBOT_WA_ef8xum.jpg",
        },
        {
            id: "2-6",
            folderId: "folder-2",
            subCategoryId: "sub-2-6",
            name: "Sewa Bot Premium VVIP 1 Tahunan",
            description: "Bot WhatsApp Multi Device Cocok Untuk Menjaga Grup Dan lainnya. Serta Akses Premium Untuk Semua Admin Grup",
            price: 80000,
            thumbnail: "https://res.cloudinary.com/duemncbn0/image/upload/v1768468525/ROBOT_WA_ef8xum.jpg",
        },
